...
const EOIFinalReport = () => {
    ...
    return (
        <div>
            ...
            <div style={titles}>
            <AccessInfo style={{ margin: "0 20px 0 0" }}>Internship EOI Final Report</AccessInfo>
            </div>
...

            {
                ...
                <ul className="responsive-table">
                    ...
                    <TRow
                        ...
                        title3 = {data.endDate}
                        title4 = {data.status}
                        rowClicked = {async(datapassed)=>{
                            // setmodaldialog(true);
                            // setModalDialogContent({content:"",type:"", loading:true});
                            // const result = await getapicallhelper(`liason/GetEOIFinalReportByDurationId?Id=${data.id}`, {});
