...
const SupStudentPendingGrade = () => {
    ...
    const fetchalldata = async () => {
        // setLoading(true);
        // const result = await getapicallhelper("liason/GetUniversitySupervisorStudentPendingGrade", {});
    ...
    const submitdata = async() =>{
        ...
        const result = await postapicallhelper("Liason/UniversitySupervisorScorePendingGrade", formData);
        if(result.success == true){
                ...
                <ul className="responsive-table">
                    ...
                    <TRow
                        ...
                        rowClicked = {(datapassed)=>{
                            let oldData = Object.assign({}, formData);
                            oldData["id"] = data?.id;
                            oldData["score"] = data?.universitySupervisorGradeScore;
                            setFormData(oldData);
...
export default SupStudentPendingGrade;
